...
public class CardHelper extends HelperBase {
  ...
  public void openModifyCardPage(){
    click(By.xpath("//div[@id='root']/div/div[3]/div/div/div[2]/div[2]/div[2]/div[5]/span/div/div/span"));
    click(By.xpath("//div[@id='root']/div/div[3]/div/div/div[2]/div[2]/div[2]/div[5]/span/div/div[2]/div/div/p"));
  }

  public void clickOnOpenSetOwnerPopUpButton(){
    click(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div/div[2]/div[1]/div/div[2]/div/span"));
  }
